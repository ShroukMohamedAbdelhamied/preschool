...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
      ...
      <!-- Custom template | don'include it in your project! -->
    ...
    <!-- Kaiadmin DEMO methods, don'include it in your project! -->
    ...
    <script>
      $("#displayNotif").on("click", function () {
        ...
        content.message =
          'rning standard Bootstrap alerts into "notify" like notifications';
