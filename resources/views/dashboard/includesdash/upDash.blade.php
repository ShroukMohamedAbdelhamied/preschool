<div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Kinder Preschool</h3>
                <h6 class="op-7 mb-2">The Best Kindergarten School For Children</h6>
              </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Students Subscribers</p>
                          <h4 class="card-title">15.000</h4>
                        </div>
                      </div>
                    </div>
                  </div>
